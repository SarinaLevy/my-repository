...
# Get parameters from parameters store in amazon
ssm = boto3.client('ssm')
response = ssm.get_parameter(Name='/clarusway/sarina/password')
pw = response['Parameter']['Value']
response = ssm.get_parameter(Name='/clarusway/sarina/endpoint')
